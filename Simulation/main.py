...
class DeltaArrayEnvironment():
    def __init__(self, yaml_path, run_no):
        ...
        if not os.path.exists('./data/manip_data'):   
            ...
            os.makedirs('./data/pre_manip_data')
            os.makedirs('./data/post_manip_data')
            os.makedirs('./data/graph_manip_data')
            os.makedirs('./data/embed_manip_data')
        if not os.path.exists('./data_smol/manip_data'):   
            os.makedirs('./data_smol/manip_data')
            os.makedirs('./data_smol/pre_manip_data')
            os.makedirs('./data_smol/post_manip_data')
            os.makedirs('./data_smol/graph_manip_data')
            os.makedirs('./data_smol/embed_manip_data')
