...
def get_obj_dict(GymURDFAsset, scene, cfg):
    objects = {'block': [GymURDFAsset('assets/block.urdf', scene, 
                    ...
                    assets_root=Path('config')), gymapi.Vec3(-0.4, -0.4, 1.002), gymapi.Quat(0, 0, 0, 1)], 
                'disc': [GymURDFAsset('assets/disc.urdf', scene, 
                    shape_props=cfg['object']['shape_props'], 
                    rb_props=cfg['object']['rb_props'],
                    asset_options=cfg['object']['asset_options'],
                    assets_root=Path('config')), gymapi.Vec3(-0.3, -0.4, 1.002), gymapi.Quat(0, 0, 0, 1)], 
                ...
                'hexagon': [GymURDFAsset('assets/hexagon.urdf', scene, 
                    ...
                    rb_props=cfg['object']['rb_props'],
                    asset_options=cfg['object']['asset_options'],
                    assets_root=Path('config')), gymapi.Vec3(-0.2, -0.4, 1.002), gymapi.Quat(0, 0, 0, 1)],
                'parallelogram': [GymURDFAsset('assets/parallelogram.urdf', scene, 
                    shape_props=cfg['object']['shape_props'], 
                    rb_props=cfg['object']['rb_props'],
                    asset_options=cfg['object']['asset_options'],
                    assets_root=Path('config')), gymapi.Vec3(-0.1, -0.4, 1.002), gymapi.Quat(0, 0, 0, 1)],
                'semicircle': [GymURDFAsset('assets/semicircle.urdf', scene, 
                    shape_props=cfg['object']['shape_props'], 
                    rb_props=cfg['object']['rb_props'],
                    asset_options=cfg['object']['asset_options'],
                    assets_root=Path('config')), gymapi.Vec3(0, -0.4, 1.002), gymapi.Quat(0, 0, 0, 1)],
                ...
                'star': [GymURDFAsset('assets/star.urdf', scene, 
                    ...
                    rb_props=cfg['object']['rb_props'],
                    asset_options=cfg['object']['asset_options'],
                    assets_root=Path('config')), gymapi.Vec3(-0.4, -0.3, 1.002), gymapi.Quat(0, 0, 0, 1)],
                'trapezium': [GymURDFAsset('assets/trapezium.urdf', scene, 
                    shape_props=cfg['object']['shape_props'], 
                    rb_props=cfg['object']['rb_props'],
                    asset_options=cfg['object']['asset_options'],
                    assets_root=Path('config')), gymapi.Vec3(-0.4, -0.2, 1.002), gymapi.Quat(0, 0, 0, 1)],
                'triangle': [GymURDFAsset('assets/triangle.urdf', scene, 
                    shape_props=cfg['object']['shape_props'], 
                    rb_props=cfg['object']['rb_props'],
                    asset_options=cfg['object']['asset_options'],
                    assets_root=Path('config')), gymapi.Vec3(-0.4, -0.1, 1.002), gymapi.Quat(0, 0, 0, 1)],
                }
