...
def ddpg(env_dict, actor_critic=core.MLPActorCritic, ac_kwargs=dict(), seed=0, 
    ...
    obs_dim = self.env_dict['observation_space']['dim']
    act_dim = self.env_dict['action_space']['dim']

    # Action limit for clamping: critically, assumes all dimensions share the same bound!
    act_limit = self.env_dict['action_space']['high']
    ...
    def get_action(o, noise_scale):
        a = self.rescale_action(ac.act(torch.as_tensor(o, dtype=torch.float32)))
